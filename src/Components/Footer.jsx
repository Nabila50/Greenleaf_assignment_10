  ...
  return (
    <div>
      <footer className="footer sm:footer-horizontal bg-lime-200 text-base-content justify-between p-10">
        ...
        <nav className="lobster-regular">
          <h6 className="footer-title">Company Info</h6>
          <Link to={'/'} className="link link-hover" >About us</Link>
          <Link to={'/myTips'} className="link link-hover">Contact</Link>
          <Link to={'/myTips'} className="link link-hover">Email:greenleaf@db.com</Link>
          <Link to={'/myTips'} className="link link-hover">Phone: 123456</Link>
        </nav>
        ...
        <nav className="lobster-regular">
          ...
          <Link to={'/'} className="link link-hover">Regulations</Link>
          <Link to={'/'} className="link link-hover">Cookie Policy</Link>
        </nav>
        
        <nav className="lobster-regular">
          <h6 className="footer-title">Available on </h6>
